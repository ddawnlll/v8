...
class DonchianBreakoutExpert(Expert):
    ...
    # stop_r is structural: the distance to the frozen channel band the
    # breakout left (D-028), computed in evaluate(); target_r stays the family
    # 1:1 default.
    stop_r = None
    ...
    def evaluate(self, state: MarketState) -> ExpertEvaluation:
        ...
        geom.update({'atr_ref': atr, 'prior_high_ref': window_high,
