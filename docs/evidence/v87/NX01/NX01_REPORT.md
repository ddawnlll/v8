...
| R4 | `FundingRow.interval_defaulted`, ölçülen interval histogramı, `absence_notes` | `tape_inventory.json` → `funding_interval_counts` | aynı pytest + `tools/tape_inventory.py` | PASS — SOL 2h×99 / 4h×2 / 8h×4357; mark price YOK kayıtlı |
