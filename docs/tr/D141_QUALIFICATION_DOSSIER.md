...
| `candlestick_reversal:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `volume_climax_reversal:v2` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `gap_exhaustion:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `bollinger_reversion:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `bollinger_breakout:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
...
| `pandf_breakout:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `ichimoku_cloud:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `rsi_stoch_reversion:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `divergence_12_setups:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `pattern_measuring_objective:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
| `fib_rsi_bb_confluence:v1` | test kanıtındaki D-141 manifest hash'i | EWQ-01…06 geçerse yalnız `SEMANTICALLY_QUALIFIED` | `NO_ECONOMIC_CLAIM` |
