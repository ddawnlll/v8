...
Verdict evidence: `{'section3': 'actual -0.1386 inside the random-entry null [-0.1435, -0.0497] (percentile 7.0%) — signal indistinguishable from random entries'}`
...
## 3 — Null baselines
random-entry median=-0.0984 (actual percentile 7.0%)
inverted=-0.0637 always_long=-0.2232 always_short=0.0262
