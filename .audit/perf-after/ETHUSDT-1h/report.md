...
Verdict evidence: `{'section3': 'actual -0.1054 inside the random-entry null [-0.1357, -0.0461] (percentile 35.0%) — signal indistinguishable from random entries'}`
...
## 3 — Null baselines
random-entry median=-0.0933 (actual percentile 35.0%)
inverted=-0.0560 always_long=-0.2064 always_short=0.0010
