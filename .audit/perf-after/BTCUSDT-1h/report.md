...
Verdict evidence: `{'section3': 'actual -0.1116 inside the random-entry null [-0.1308, -0.0317] (percentile 20.5%) — signal indistinguishable from random entries'}`
...
## 3 — Null baselines
random-entry median=-0.0827 (actual percentile 20.5%)
inverted=-0.0607 always_long=-0.1674 always_short=-0.0334
