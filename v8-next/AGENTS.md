...
as the sole active product implementation. `src/v8/`, root `tests/`, and
`v8-core/` remain frozen historical references for this task. Do not import
their runtime or compile legacy Rust for new-product checks. Preserve unrelated
user changes.
