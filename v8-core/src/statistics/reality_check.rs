...
mod tests {
    ...
    fn select_block_size_matches_cpython() {
        ...
        // doubled (|lag1| > 0.10) -> 6
        let s20 = [
            -0.365636, 0.347434, 0.263775, -0.244931, -0.004565, -0.050509, 0.151593, 0.288723,
            -0.40614, -0.471653, 0.335765, -0.067233, 0.26228, -0.497894, -0.054613, 0.22154,
            -0.271238, 0.445271, 0.401427, -0.46941,
        ];
    ...
    fn block_bootstrap_means_matches_cpython() {
        ...
        assert_eq!(
            block_bootstrap_means(&[], 4, 5, 1).unwrap(),
            Vec::<f64>::new()
        );
    }
